...
const SecurityCard = () => {
    return (
        <Card className="!p-7 !w-full !bg-white !rounded-[20px] !shadow-none !border-none">
            <CardContent className="!p-0">
                ...
                <SecondaryButton title="Get Started" className="!rounded-[16px] !bg-[--divider-color] !w-full !text-white !mt-4 !text-center !text-sm Poppins700"/>
            </CardContent>
        </Card>
    );
};
