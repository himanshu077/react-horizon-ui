...
const Header = ({ title, showEthInfo }) => {
  ...
  return (
    <div className="container lg:max-w-8xl max-w-full lg:mx-auto lg:pt-10">
      <div className="flex lg:flex-row flex-col gap-4 lg:justify-between items-center">
        <h3 className="text-[--logo-color] lg:text-4xl text-2xl leading-10">
          {title}
        </h3>
        <div
          className="relative p-2 my-5 hidden bg-[--signin-bg] lg:flex items-center gap-4 rounded-full"
        ...
        >
          ...
          <div onClick={handleChange}>
            {value === "light" ? (
              ...
              <FaRegSun className="text-tab-color" />
            )}
          </div>
